...
T = TypeVar("T", bound="PaginatedTaskKindList")


@_attrs_define
class PaginatedTaskKindList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TaskKind.from_dict(results_item_data)
        ...
        paginated_task_kind_list.additional_properties = d
