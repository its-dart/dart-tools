...
T = TypeVar("T", bound="PaginatedDashboardList")
...
class PaginatedDashboardList:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Dashboard.from_dict(results_item_data)
        ...
        paginated_dashboard_list.additional_properties = d
