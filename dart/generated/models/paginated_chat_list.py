...
T = TypeVar("T", bound="PaginatedChatList")
...
class PaginatedChatList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Chat.from_dict(results_item_data)
        ...
        paginated_chat_list.additional_properties = d
        return paginated_chat_list
