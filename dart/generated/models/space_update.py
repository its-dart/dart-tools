...
if TYPE_CHECKING:
    from ..models.space_update_changelog_recurrence import SpaceUpdateChangelogRecurrence
    from ..models.space_update_standup_recurrence import SpaceUpdateStandupRecurrence
...
class SpaceUpdate:
    ...
    Attributes:
        ...
        cycle_mode (Union[Unset, CycleMode]): * `None` - NONE
            * `ANBA` - ANBA
        standup_recurrence (Union[Unset, None, SpaceUpdateStandupRecurrence]):
        standup_recurrs_next_at (Union[Unset, None, datetime.datetime]):
        changelog_recurrence (Union[Unset, None, SpaceUpdateChangelogRecurrence]):
    ...
    standup_recurrence: Union[Unset, None, "SpaceUpdateStandupRecurrence"] = UNSET
    standup_recurrs_next_at: Union[Unset, None, datetime.datetime] = UNSET
    changelog_recurrence: Union[Unset, None, "SpaceUpdateChangelogRecurrence"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _standup_recurrence is None:
            ...
            standup_recurrence = SpaceUpdateStandupRecurrence.from_dict(_standup_recurrence)
        ...
        if _changelog_recurrence is None:
            ...
            changelog_recurrence = SpaceUpdateChangelogRecurrence.from_dict(_changelog_recurrence)
